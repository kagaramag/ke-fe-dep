<template>
  <div id="kids" class="mb-3">
    <!-- Kids -->
    <h2 class="my-4">
      <icon class="icon" icon="child" />&nbsp;My Kids
...
.option-nav .dropdown-menu li { position: relative; left:0px }
.option-nav .dropdown-menu li .icon{ margin-left: -10px;color:#b3b3b3 }
</style>