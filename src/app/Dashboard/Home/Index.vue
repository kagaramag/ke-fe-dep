  ...
  <div>
    <component :is="layout">
      ...
      <div v-if="loaded">
        <div class="py-2">
          <img
            src="@/assets/images/welcome-dashboard.svg"
            alt="Welcome"
            style="max-width:380px;width:90%;display:block;margin:0 auto"
            class="img-fluid"
          />
        </div>
...
import Tutor from "@/app/Dashboard/Tutors";
import Parent from "@/app/Dashboard/Parents";
