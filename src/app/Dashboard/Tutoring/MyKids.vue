  ...
  <div id="my-kids">
    <h2 class="mb-4" v-show="!fetch_kids.loading && fetch_kids && fetch_kids.kids.length !== 0">
      ...
      <span class="float-right">
        <b-button id="show-btn" class="btn btn-primary rounded px-3" @click="popUserForm()">
    ...
    <div>
                ...
                <div class="mb-3" v-if="kid.tutoring && kid.tutoring.status ==='rejected' ">
                  ...
                  <div class="my-1-">
                    <router-link
                      ...
                      class="btn btn-outline-dark rounded px-4"
                    >Search tutors</router-link>
                    <button v-if="kid.tutoring" class="btn btn-outline-success rounded px-4">
                      Go to tutorship
                      <icon class="icon" icon="arrow-right" />
                    </button>
                  </div>
      ...
      >
        ...
        <div class="my-4">
          <button class="btn btn-primary px-5 rounded" @click="popUserForm()">Register now</button>
        </div>
        <img
        ...
        <div class="col m-4">
          ...
          >
            ...
            <div class="row">
              ...
              >Submit</button>
              <b-button class="btn btn-light rounded px-3 ml-2" @click="$bvModal.hide('register')">Cancel</b-button>
