          ...
          <div class="container">
            <div class="py-4 px-2 text-white">
              ...
              <h3 class="font-weight-light mb-3">
                Let's your children start achieving better results today!
              </h3>
              <button
              ...
              <button
                class="btn btn-lg px-3 ml-3 btn-light rounded"
                @click="$bvModal.show('become-tutor')"
              >
                Become a tutor
              </button>
            </div>
          ...
          <div class="row">
            <div class="col-sm-12 col-md-10">
              <div class="p-4 my-3 radius-2">
                ...
                <div class="py-1">
                  <div>
                    If you have any issues, concerns, feedback or questions.
                  </div>
                  <div class="my-3">
                    <div
